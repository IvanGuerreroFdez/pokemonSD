...
public class AbstractFactoryGen8 implements AbstractFactory {
    ...
    public Character createGrass() {
        ...
        try {
            ...
            while(sc.hasNextLine() && lineCount < 21) {
                sc.nextLine();
                lineCount++;
            }
    ...
    public Character createFire() {
        ...
        try {
            ...
            while(sc.hasNextLine() && lineCount < 22) {
                sc.nextLine();
                lineCount++;
            }
    ...
    public Character createWater() {
        ...
        try {
            ...
            while(sc.hasNextLine() && lineCount < 23) {
                sc.nextLine();
                lineCount++;
            }
