...
public class AbstractFactoryGen2 implements AbstractFactory {
    ...
    public Character createGrass() {
        ...
        try {
            ...
            while(sc.hasNextLine() && lineCount < 3) {
                sc.nextLine();
                lineCount++;
            }
    ...
    public Character createFire() {
        ...
        try {
            ...
            while(sc.hasNextLine() && lineCount < 4) {
                sc.nextLine();
                lineCount++;
            }
    ...
    public Character createWater() {
        ...
        try {
            ...
            while(sc.hasNextLine() && lineCount < 5) {
                sc.nextLine();
                lineCount++;
            }
