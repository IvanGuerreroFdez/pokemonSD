...
public class AbstractFactoryGen7 implements AbstractFactory {
    ...
    public Character createGrass() {
        ...
        try {
            ...
            while(sc.hasNextLine() && lineCount < 18) {
                sc.nextLine();
                lineCount++;
            }
    ...
    public Character createFire() {
        ...
        try {
            ...
            while(sc.hasNextLine() && lineCount < 19) {
                sc.nextLine();
                lineCount++;
            }
    ...
    public Character createWater() {
        ...
        try {
            ...
            while(sc.hasNextLine() && lineCount < 20) {
                sc.nextLine();
                lineCount++;
            }
