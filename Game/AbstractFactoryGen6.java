...
public class AbstractFactoryGen6 implements AbstractFactory {
    ...
    public Character createGrass() {
        ...
        try {
            ...
            while(sc.hasNextLine() && lineCount < 15) {
                sc.nextLine();
                lineCount++;
            }
    ...
    public Character createFire() {
        ...
        try {
            ...
            while(sc.hasNextLine() && lineCount < 16) {
                sc.nextLine();
                lineCount++;
            }
    ...
    public Character createWater() {
        ...
        try {
            ...
            while(sc.hasNextLine() && lineCount < 17) {
                sc.nextLine();
                lineCount++;
            }
