...
public class DamageCalculator {
    public static int damageCalculator(Character attacker, Character receiver, int moveNo) { // Calculates the damage of a move
        ...
        int damage = (int) Math.round(((((2 * 50 / 5 + 2) * attacker.moves[moveNo].power * atk / def) / 50 + 2) * random * 1.5 * type * critical));
