...
public class AbstractFactoryGen9 implements AbstractFactory {
    ...
    public Character createGrass() {
        ...
        try {
            ...
            while(sc.hasNextLine() && lineCount < 24) {
                sc.nextLine();
                lineCount++;
            }
    ...
    public Character createFire() {
        ...
        try {
            ...
            while(sc.hasNextLine() && lineCount < 25) {
                sc.nextLine();
                lineCount++;
            }
    ...
    public Character createWater() {
        ...
        try {
            ...
            while(sc.hasNextLine() && lineCount < 26) {
                sc.nextLine();
                lineCount++;
            }
